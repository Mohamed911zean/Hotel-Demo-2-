...
export const metadata: Metadata = {
  ...
  description: 'Experience ultimate luxury at Royal Palace Hotel. World-class suites, exquisite amenities, and unforgettable service in the heart of Manhattan.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
